...
class NextWaypointActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new NextWaypointFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NextWaypointFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NextWaypointActionFeedback(null);
    ...
    data.feedback = NextWaypointFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += NextWaypointFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NextWaypointActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = NextWaypointFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new NextWaypointFeedback()
    }
...
module.exports = NextWaypointActionFeedback;
